...
import GeminiCommerce.Customer.auth.Authentication;
import GeminiCommerce.Customer.auth.HttpBasicAuth;
import GeminiCommerce.Customer.auth.HttpBearerAuth;
import GeminiCommerce.Customer.auth.ApiKeyAuth;
import GeminiCommerce.Customer.auth.OAuth;
import GeminiCommerce.Customer.auth.RetryingOAuth;
import GeminiCommerce.Customer.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Customer.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Customer.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Customer.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Customer.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Customer.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Customer.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Customer.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Customer.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Customer.ApiException If fail to serialize the request body object into a string
     */
