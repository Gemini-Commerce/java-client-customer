...
public class CustomerPassword {
   ...
   * @return the CustomerPassword instance itself
   */
  public CustomerPassword putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, customerPassword.data) &&
        ...
        Objects.equals(this.additionalProperties, customerPassword.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, enabled, type, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerPassword>() {
           ...
           public CustomerPassword read(JsonReader in) throws IOException {
             ...
             CustomerPassword instance = thisAdapter.fromJsonTree(jsonObj);
