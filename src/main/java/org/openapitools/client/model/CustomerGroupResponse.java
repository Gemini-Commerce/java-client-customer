...
public class CustomerGroupResponse {
   ...
   * @return the CustomerGroupResponse instance itself
   */
  public CustomerGroupResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customerGroupResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, customerGroupResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, customerIds, createdAt, updatedAt, grn, code, customerCount, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerGroupResponse>() {
           ...
           public CustomerGroupResponse read(JsonReader in) throws IOException {
             ...
             CustomerGroupResponse instance = thisAdapter.fromJsonTree(jsonObj);
