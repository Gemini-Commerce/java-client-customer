...
public class CustomerAddressUpdateRequest {
   ...
   * @return the CustomerAddressUpdateRequest instance itself
   */
  public CustomerAddressUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, customerAddressUpdateRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, customerAddressUpdateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, customerId, id, address, fieldMask, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerAddressUpdateRequest>() {
           ...
           public CustomerAddressUpdateRequest read(JsonReader in) throws IOException {
             ...
             CustomerAddressUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
