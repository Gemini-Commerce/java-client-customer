...
public class CustomerCustomerResponse {
  ...
  private List<CustomerAddressCustomerResponse> addresses = new ArrayList<>();
  ...
  private List<CustomerPermission> permissions = new ArrayList<>();
  ...
  public CustomerCustomerResponse() {
  }

  public CustomerCustomerResponse em(CustomerEMFields em) {
    this.em = em;
    return this;
  }
  ...
  public CustomerCustomerResponse grn(String grn) {
    this.grn = grn;
    return this;
  }
  ...
  public CustomerCustomerResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CustomerCustomerResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomerCustomerResponse surname(String surname) {
  ...
  public CustomerCustomerResponse email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CustomerCustomerResponse birthdate(OffsetDateTime birthdate) {
  ...
  public CustomerCustomerResponse gender(String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public CustomerCustomerResponse enabled(Boolean enabled) {
  ...
  public CustomerCustomerResponse source(String source) {
    this.source = source;
    return this;
  }
  ...
  public CustomerCustomerResponse addresses(List<CustomerAddressCustomerResponse> addresses) {
    this.addresses = addresses;
    return this;
  }

  public CustomerCustomerResponse addAddressesItem(CustomerAddressCustomerResponse addressesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CustomerAddressCustomerResponse> getAddresses() {
    return addresses;
  }

  public void setAddresses(List<CustomerAddressCustomerResponse> addresses) {
    this.addresses = addresses;
  }


  public CustomerCustomerResponse defaultBillingAddressId(String defaultBillingAddressId) {
  ...
  public CustomerCustomerResponse defaultShippingAddressId(String defaultShippingAddressId) {
  ...
  public CustomerCustomerResponse phoneNumber(String phoneNumber) {
  ...
  public CustomerCustomerResponse nationality(String nationality) {
  ...
  public CustomerCustomerResponse preferredLocale(String preferredLocale) {
  ...
  public CustomerCustomerResponse groups(List<String> groups) {
    this.groups = groups;
    return this;
  }

  public CustomerCustomerResponse addGroupsItem(String groupsItem) {
    if (this.groups == null) {
  ...
  public CustomerCustomerResponse createdAt(OffsetDateTime createdAt) {
  ...
  public CustomerCustomerResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  public CustomerCustomerResponse deleted(Boolean deleted) {
  ...
  public CustomerCustomerResponse deletedAt(OffsetDateTime deletedAt) {
  ...
  public CustomerCustomerResponse newsletters(List<CustomerNewsletterResponse> newsletters) {
    this.newsletters = newsletters;
    return this;
  }

  public CustomerCustomerResponse addNewslettersItem(CustomerNewsletterResponse newslettersItem) {
  ...
  public CustomerCustomerResponse migratedPassword(CustomerPassword migratedPassword) {
  ...
  public CustomerCustomerResponse attributes(Map<String, ProtobufAny> attributes) {
    this.attributes = attributes;
    return this;
  }

  public CustomerCustomerResponse putAttributesItem(String key, ProtobufAny attributesItem) {
  ...
  public CustomerCustomerResponse taxCode(String taxCode) {
  ...
  public CustomerCustomerResponse certifiedEmail(String certifiedEmail) {
  ...
  public CustomerCustomerResponse sdiCode(String sdiCode) {
  ...
  public CustomerCustomerResponse fiscalCode(String fiscalCode) {
  ...
  public CustomerCustomerResponse companyName(String companyName) {
  ...
  public CustomerCustomerResponse additionalInfo(Object additionalInfo) {
  ...
  public CustomerCustomerResponse market(String market) {
    this.market = market;
    return this;
  }
  ...
  public CustomerCustomerResponse permissions(List<CustomerPermission> permissions) {
    this.permissions = permissions;
    return this;
  }

  public CustomerCustomerResponse addPermissionsItem(CustomerPermission permissionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CustomerPermission> getPermissions() {
    return permissions;
  }

  public void setPermissions(List<CustomerPermission> permissions) {
    this.permissions = permissions;
  }


  public CustomerCustomerResponse externalIds(Map<String, String> externalIds) {
    this.externalIds = externalIds;
    return this;
  }

  public CustomerCustomerResponse putExternalIdsItem(String key, String externalIdsItem) {
  ...
  public CustomerCustomerResponse agentGrn(String agentGrn) {
  ...
  public CustomerCustomerResponse aggregationId(String aggregationId) {
   ...
   * @return the CustomerCustomerResponse instance itself
   */
  public CustomerCustomerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomerCustomerResponse customerCustomerResponse = (CustomerCustomerResponse) o;
    return Objects.equals(this.em, customerCustomerResponse.em) &&
        Objects.equals(this.grn, customerCustomerResponse.grn) &&
        Objects.equals(this.id, customerCustomerResponse.id) &&
        Objects.equals(this.name, customerCustomerResponse.name) &&
        Objects.equals(this.surname, customerCustomerResponse.surname) &&
        Objects.equals(this.email, customerCustomerResponse.email) &&
        Objects.equals(this.birthdate, customerCustomerResponse.birthdate) &&
        Objects.equals(this.gender, customerCustomerResponse.gender) &&
        Objects.equals(this.enabled, customerCustomerResponse.enabled) &&
        Objects.equals(this.source, customerCustomerResponse.source) &&
        Objects.equals(this.addresses, customerCustomerResponse.addresses) &&
        Objects.equals(this.defaultBillingAddressId, customerCustomerResponse.defaultBillingAddressId) &&
        Objects.equals(this.defaultShippingAddressId, customerCustomerResponse.defaultShippingAddressId) &&
        Objects.equals(this.phoneNumber, customerCustomerResponse.phoneNumber) &&
        Objects.equals(this.nationality, customerCustomerResponse.nationality) &&
        Objects.equals(this.preferredLocale, customerCustomerResponse.preferredLocale) &&
        Objects.equals(this.groups, customerCustomerResponse.groups) &&
        Objects.equals(this.createdAt, customerCustomerResponse.createdAt) &&
        Objects.equals(this.updatedAt, customerCustomerResponse.updatedAt) &&
        Objects.equals(this.deleted, customerCustomerResponse.deleted) &&
        Objects.equals(this.deletedAt, customerCustomerResponse.deletedAt) &&
        Objects.equals(this.newsletters, customerCustomerResponse.newsletters) &&
        Objects.equals(this.migratedPassword, customerCustomerResponse.migratedPassword) &&
        Objects.equals(this.attributes, customerCustomerResponse.attributes) &&
        Objects.equals(this.taxCode, customerCustomerResponse.taxCode) &&
        Objects.equals(this.certifiedEmail, customerCustomerResponse.certifiedEmail) &&
        Objects.equals(this.sdiCode, customerCustomerResponse.sdiCode) &&
        Objects.equals(this.fiscalCode, customerCustomerResponse.fiscalCode) &&
        Objects.equals(this.companyName, customerCustomerResponse.companyName) &&
        Objects.equals(this.additionalInfo, customerCustomerResponse.additionalInfo) &&
        Objects.equals(this.market, customerCustomerResponse.market) &&
        Objects.equals(this.permissions, customerCustomerResponse.permissions) &&
        Objects.equals(this.externalIds, customerCustomerResponse.externalIds) &&
        Objects.equals(this.agentGrn, customerCustomerResponse.agentGrn) &&
        Objects.equals(this.aggregationId, customerCustomerResponse.aggregationId)&&
        Objects.equals(this.additionalProperties, customerCustomerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(em, grn, id, name, surname, email, birthdate, gender, enabled, source, addresses, defaultBillingAddressId, defaultShippingAddressId, phoneNumber, nationality, preferredLocale, groups, createdAt, updatedAt, deleted, deletedAt, newsletters, migratedPassword, attributes, taxCode, certifiedEmail, sdiCode, fiscalCode, companyName, additionalInfo, market, permissions, externalIds, agentGrn, aggregationId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomerCustomerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerCustomerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerCustomerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerCustomerResponse is not found in the empty JSON string", CustomerCustomerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("addresses") != null && !jsonObj.get("addresses").isJsonNull()) {
        ...
        if (jsonArrayaddresses != null) {
          ...
          for (int i = 0; i < jsonArrayaddresses.size(); i++) {
            CustomerAddressCustomerResponse.validateJsonElement(jsonArrayaddresses.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerCustomerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerCustomerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerCustomerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerCustomerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerCustomerResponse>() {
           @Override
           public void write(JsonWriter out, CustomerCustomerResponse value) throws IOException {
           ...
           @Override
           public CustomerCustomerResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CustomerCustomerResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CustomerCustomerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomerCustomerResponse
   * @throws IOException if the JSON string is invalid with respect to CustomerCustomerResponse
   */
  public static CustomerCustomerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerCustomerResponse.class);
  }

  /**
   * Convert an instance of CustomerCustomerResponse to an JSON string
   *
   * @return JSON string
   */
