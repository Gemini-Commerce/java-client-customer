...
public class CustomerBulkUpdateRequest {
   ...
   * @return the CustomerBulkUpdateRequest instance itself
   */
  public CustomerBulkUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, customerBulkUpdateRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, customerBulkUpdateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, customerIds, action, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerBulkUpdateRequest>() {
           ...
           public CustomerBulkUpdateRequest read(JsonReader in) throws IOException {
             ...
             CustomerBulkUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
