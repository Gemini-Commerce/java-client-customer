...
public class CustomerListConsentsRequest {
  ...
  private List<ListConsentsRequestSort> sorts;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, pageSize, pageToken, sorts, filtersMask, filters);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerListConsentsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerListConsentsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
