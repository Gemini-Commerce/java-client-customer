...
public class CustomerUpdateRequest {
   ...
   * @return the CustomerUpdateRequest instance itself
   */
  public CustomerUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, customerUpdateRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, customerUpdateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, customerId, payload, fieldMask, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerUpdateRequest>() {
           ...
           public CustomerUpdateRequest read(JsonReader in) throws IOException {
             ...
             CustomerUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
