...
import GeminiCommerce_Customer.auth.Authentication;
import GeminiCommerce_Customer.auth.HttpBasicAuth;
import GeminiCommerce_Customer.auth.HttpBearerAuth;
import GeminiCommerce_Customer.auth.ApiKeyAuth;
import GeminiCommerce_Customer.auth.OAuth;
import GeminiCommerce_Customer.auth.RetryingOAuth;
import GeminiCommerce_Customer.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://cdp.api.gogemini.io";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cdp.api.gogemini.io
     ...
     * @return a {@link GeminiCommerce_Customer.ApiClient} object
     */
     ...
     * @throws GeminiCommerce_Customer.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce_Customer.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce_Customer.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce_Customer.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce_Customer.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce_Customer.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce_Customer.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce_Customer.ApiException If fail to serialize the request body object into a string
     */
