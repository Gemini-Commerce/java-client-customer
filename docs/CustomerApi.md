...
<a id="customerSetDefaultAddress"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CustomerCustomerResponse result = apiInstance.customerSetDefaultAddress(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerSetDefaultAddress");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customerSetDefaultAddress2"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerSetDefaultAddressRequest body = new CustomerSetDefaultAddressRequest(); // CustomerSetDefaultAddressRequest | 
    try {
      CustomerCustomerResponse result = apiInstance.customerSetDefaultAddress2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerSetDefaultAddress2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customerSetPermissions"></a>
# **customerSetPermissions**
> Object customerSetPermissions(body)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.customerSetPermissions(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerSetPermissions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customerSetPermissions2"></a>
# **customerSetPermissions2**
> Object customerSetPermissions2(body)
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerSetPermissionsRequest body = new CustomerSetPermissionsRequest(); // CustomerSetPermissionsRequest | 
    try {
      Object result = apiInstance.customerSetPermissions2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerSetPermissions2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customerUnassignAgent"></a>
# **customerUnassignAgent**
> Object customerUnassignAgent(body)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.customerUnassignAgent(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUnassignAgent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerUnsubscribeRequest body = new CustomerUnsubscribeRequest(); // CustomerUnsubscribeRequest | 
    try {
      CustomerUnsubscribeResponse result = apiInstance.customerUnsubscribe(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUnsubscribe");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerUnsubscribeRequest body = new CustomerUnsubscribeRequest(); // CustomerUnsubscribeRequest | 
    try {
      CustomerUnsubscribeResponse result = apiInstance.customerUnsubscribe2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUnsubscribe2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CustomerCustomerResponse result = apiInstance.customerUpdate(body);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerUpdateRequest body = new CustomerUpdateRequest(); // CustomerUpdateRequest | 
    try {
      CustomerCustomerResponse result = apiInstance.customerUpdate2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdate2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CustomerAddressUpdateResponse result = apiInstance.customerUpdateAddress(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdateAddress");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerAddressUpdateRequest body = new CustomerAddressUpdateRequest(); // CustomerAddressUpdateRequest | 
    try {
      CustomerAddressUpdateResponse result = apiInstance.customerUpdateAddress2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdateAddress2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CustomerGroupResponse result = apiInstance.customerUpdateGroup(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdateGroup");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerUpdateGroupRequest body = new CustomerUpdateGroupRequest(); // CustomerUpdateGroupRequest | 
    try {
      CustomerGroupResponse result = apiInstance.customerUpdateGroup2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdateGroup2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customerUpdateSubscriber"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CustomerSubscriberResponse result = apiInstance.customerUpdateSubscriber(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdateSubscriber");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customerUpdateSubscriber2"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerUpdateSubscriberRequest body = new CustomerUpdateSubscriberRequest(); // CustomerUpdateSubscriberRequest | 
    try {
      CustomerSubscriberResponse result = apiInstance.customerUpdateSubscriber2(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerApi#customerUpdateSubscriber2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
